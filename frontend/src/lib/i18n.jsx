...
const translations = {
  en: {
    ...
    services: {
      ...
      visitUs: 'Visit Us', location: '2125 Biscayne Blvd Suite 336, Miami, FL 33137',
    ...
    footer: { address: '2125 Biscayne Blvd Suite 336, Miami, FL 33137', tagline: 'Fingerprints • Apostilles • FBI Background Checks' },
    menu: {
  ...
  es: {
    ...
    services: {
      ...
      visitUs: 'Visítenos', location: '2125 Biscayne Blvd Suite 336, Miami, FL 33137',
    ...
    footer: { address: '2125 Biscayne Blvd Suite 336, Miami, FL 33137', tagline: 'Huellas Dactilares • Apostillas • Verificación FBI' },
    menu: {
  ...
  ht: {
    ...
    services: {
      ...
      visitUs: 'Vizite Nou', location: '2125 Biscayne Blvd Suite 336, Miami, FL 33137',
    ...
    footer: { address: '2125 Biscayne Blvd Suite 336, Miami, FL 33137', tagline: 'Anprent • Apostiy • Verifikasyon FBI' },
    menu: {
  ...
  pt: {
    ...
    services: {
      ...
      visitUs: 'Visite-nos', location: '2125 Biscayne Blvd Suite 336, Miami, FL 33137',
    ...
    footer: { address: '2125 Biscayne Blvd Suite 336, Miami, FL 33137', tagline: 'Impressões Digitais • Apostilas • Verificação FBI' },
    menu: {

      ...
      <div className="flex items-center justify-between">
        ...
        {pipeline.summary && (
          <div className="text-right">
            ...
            <p className="text-sm font-medium text-teal-700">${pipeline.summary.revenue || 0} revenue</p>
          </div>
        )}
      </div>
...
function OrderCard({ order, status, onTransition }) {
  ...
  return (
    <div className="bg-white rounded-md border p-3 shadow-sm">
      ...
      {order.totalPrice && (
        <p className="text-xs text-teal-600 font-medium mt-1">${order.totalPrice}</p>
      )}
      ...
      {nextStatus && (
        <button
          ...
          className="mt-2 w-full text-xs bg-teal-50 text-teal-700 py-1 rounded hover:bg-teal-100 font-medium transition"
        >
